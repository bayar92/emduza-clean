...
const subLinks = [
  ...
  { href: '/erkhzui/togtool', label: 'Засгийн газрын тогтоол' },
  {
...
export default async function EmduzTogtoolPage() {
  const docs = await prisma.stCommittee.findMany({
    where: { category: 'ЭМДҮЗ-ийн тогтоол' },
    orderBy: { Date: 'desc' },
  });
      ...
      <div className="bg-gradient-to-br from-[#0D47A1] to-[#1565C0] p-6 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex items-center gap-2 text-blue-200 text-[11px] font-bold mb-4">
            ...
            <FiChevronRight size={11} />
            <span className="text-white">ЭМДҮЗ-ийн тогтоолууд</span>
          </div>

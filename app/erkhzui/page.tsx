...
const subLinks = [
  { href: '/erkhzui', label: 'Бүгд', active: true },
...
export default async function ErkhzuiPage() {
      ...
      <div className="bg-gradient-to-br from-[#0D47A1] to-[#1565C0] relative overflow-hidden">
        ...
        <div className="container mx-auto p-6 relative z-10">
          <div className="flex items-center gap-2 text-blue-200 text-[11px] font-bold mb-4">
            ...
            <span className="text-white">Эрх зүй</span>
          </div>
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-blue-200 text-sm mt-1 font-medium">
                Хууль, тогтоол, шийдвэрийн баримт бичгүүд
              </p>
            </div>
          </div>
          {/* Sub-nav */}

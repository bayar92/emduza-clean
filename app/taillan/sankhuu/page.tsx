...
const subLinks = [
  { href: '/taillan/sankhuu', label: 'Санхүүгийн тайлан', active: true },
  { href: '/taillan/uil-ajillagaa', label: 'Үйл ажиллагааны тайлан' },
];
      ...
      <div className="bg-gradient-to-br from-[#0D47A1] to-[#1565C0] p-6 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex items-center gap-2 text-blue-200 text-[11px] font-bold mb-4">
            ...
            <span className="text-white">Санхүүгийн тайлан</span>
          </div>
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-blue-200 text-sm mt-1 font-medium">
                ЭМД-ын сангийн санхүүгийн жилийн тайлан
              </p>
            </div>
          </div>
